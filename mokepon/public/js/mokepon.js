...
let capipepo = new Mokepon("Capipepo", "./img/capipepo.png", 5, "./img/capipepo_mapa.png", 250, 250)
let ratigueya = new Mokepon("Ratigueya", "./img/ratigueya.png", 5, "./img/ratigueya_mapa.png", 450, 450)
